...
function Register(){
    ...
    const onSubmit = (data) => {
        ...
        Axios.post("http://localhost:3001/User", data).then((response) => {
          history.push('/');
          const data2 ={UserName:data.UserName,Password:data.Password}
          Axios.post("http://localhost:3001/User/login",data2).then((response)=>{
            ...
            <div class="input-container">
                ...
                className="input-field" 
                 type ="date" name="DOB" />
                    ...
                    <button type="submit" className="ButtonsControl2">Login</button>
                </Form>
                </Formik>  
                </div>
